...
export default function Bento() {
  return (
    // FIX 1: Removed the redundant gradient background (bg-linear-to-br from-slate-900 to-indigo-950).
    // The background is now transparent, allowing the parent <Hero /> gradient to show through.
    // FIX 2: Removed the negative top margin (-mt-8). Vertical spacing should be controlled
    // by the parent <section> in Hero.tsx for clean layout flow.
    <div className="overflow-hidden rounded-lg border-0">
      {/* The inner section is where max-width and padding are applied */}
      <section className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 opacity-90">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative lg:row-span-2">
            <div className="[background:linear-gradient(45deg,#0f172a,var(--color-slate-900)_50%,#0f172a)_padding-box,conic-gradient(from_var(--border-angle),var(--color-indigo-500)_80%,var(--color-violet-400)_86%,var(--color-purple-400)_90%,var(--color-violet-500)_94%,var(--color-indigo-500)_100%)_border-box] border border-transparent animate-border rounded-2xl h-full flex flex-col overflow-hidden">
          ...
          <div className="relative max-lg:row-start-1">
            <div className="[background:linear-gradient(45deg,#0f172a,var(--color-slate-900)_50%,#0f172a)_padding-box,conic-gradient(from_var(--border-angle),var(--color-violet-400)_80%,var(--color-fuchsia-500)_86%,var(--color-pink-400)_90%,var(--color-fuchsia-500)_94%,var(--color-violet-400)_100%)_border-box] border border-transparent animate-border rounded-2xl flex flex-col overflow-hidden">
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div className="[background:linear-gradient(45deg,#0f172a,var(--color-slate-900)_50%,#0f172a)_padding-box,conic-gradient(from_var(--border-angle),var(--color-emerald-400)_80%,var(--color-teal-500)_86%,var(--color-cyan-400)_90%,var(--color-teal-500)_94%,var(--color-emerald-400)_100%)_border-box] border border-transparent animate-border rounded-2xl flex flex-col overflow-hidden">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="text-lg font-medium tracking-tight text-white max-lg:text-center">
                  Security
                </p>
