// components/TeamSection.tsx (Refactored)
...
const TeamSection = () => {
  return (
    // FIX: Removed redundant background (bg-linear-to-br...) and replaced
    // min-h-screen with appropriate vertical padding (py-20) for layout.
